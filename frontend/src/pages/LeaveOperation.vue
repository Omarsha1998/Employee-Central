...
export default {
  ...
  methods: {
    ...
    //     await helperMethods.delay(500);    //     await this.$store.dispatch('leaveModule/approveLeaves', leaveIds);
    ...
    //     await helperMethods.delay(500);    //     await this.$store.dispatch('leaveModule/rejectLeaves', rejectData);
    //     this.selectedItems = [];
    //     this.fetchpendingLeaves();
