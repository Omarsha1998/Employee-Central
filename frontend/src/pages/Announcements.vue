              ...
              <q-card class="q-mb-lg">
                <q-card-section>
                  ...
                  <div style="font-size: 18px">
                    {{ getFormattedDate(announcement.dateTimeCreated) }}
                  </div>
                  <div style="font-size: 20px" class="text-bold">
                    {{ announcement.name }}
                  </div>
                </q-card-section>
                <q-card-section v-if="announcement.description">
                  <div
                    class="text-justify text-bold"
                ...
                <q-card-section class="text-center">
                  <div
                    v-if="
                      announcement.fileType === 'img' ||
                      announcement.fileType === 'jpg'
                    "
                  >
                    <img
                      :src="announcement.links"
                  ...
                  <div
                    v-else-if="
                      ...
                      announcement.fileType === 'imgDialog'
                    "
                    style="
                      display: flex;
                  ...
                  >
                    <div
                      v-if="announcement.fileType === 'imgDialog'"
                    ...
                    <div v-else class="blurred-image"></div>
                    <q-btn
                      class="shadowcard q-mt-md"
                      text-color="primary"
                      @click="openPdfLink(announcement.links)"
                      :label="
                        announcement.fileType === 'pdf'
                          ? 'CLICK FOR MORE INFO'
                          : 'VIEW IMAGE'
...
export default {
  ...
  methods: {
    ...
    getMonthAndYear(announcementID) {
      const announcement = this.sortedAnnouncements.find(
